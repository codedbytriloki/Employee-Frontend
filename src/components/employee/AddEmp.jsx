      ...
      <form onSubmit={handleSubmit}>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div>
            ...
            <input type="text" name="name" placeholder='Enter name' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' onChange={handleChange} required />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" name="employeeId" placeholder='Employee ID' onChange={handleChange} className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required />
          </div>
          <div>
