...
const AddDepartment = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://employee-backend-smoky.vercel.app/api/department/add", department, {
        headers: {
    ...
    <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md w-96'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mt-3'>
          ...
          <textarea name="description" placeholder='Description' onChange={handleChange} className='mt-1 w-full p-2 border border-gray-300 rounded-md' rows="4"></textarea>
        </div>
